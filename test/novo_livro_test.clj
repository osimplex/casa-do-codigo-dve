...
(def payload-livro-com-categoria-autor-validos
...
(def payload-livro-com-categoria-invalida
  {:titulo "titulo do livro"
   :resumo "resumo do livro"
   :preco "20.00"
   :isbn "7856745"
...
(def payload-livro-com-autor-invalido
  {:titulo "titulo do livro"
   :resumo "resumo do livro"
   :preco "20.00"
   :isbn "7856745"
...
(def payload-livro-com-titulo-duplicado
...
(def versao-banco #{[1 :categoria/nome "categoria teste"]
                    [1 :autor/nome "autor teste"]
                    [1 :livro/titulo "titulo duplicado"]})

(defn atom-id [] (atom 0))

(api/defflow deveria-cadastrar-um-livro
  {:init (constantly (utilitarios-test/cria-contexto-com-payload-e-dados
                      payload-livro-com-categoria-autor-validos versao-banco (atom-id)))}
...
(api/defflow nao-deve-cadastrar-com-categoria-invalida
  {:init (constantly (utilitarios-test/cria-contexto-com-payload-e-dados
                      payload-livro-com-categoria-invalida versao-banco (atom-id)))}
  [resposta (api/get-state utilitarios-test/executa-handler novo-livro/handler)]
  (match? 400 (:status resposta))
  (match? {:global-errors ["Nao existe a categoria referenciada"]} (:body resposta)))

(api/defflow nao-deve-cadastrar-com-autor-invalido
  {:init (constantly (utilitarios-test/cria-contexto-com-payload-e-dados
                      payload-livro-com-autor-invalido versao-banco (atom-id)))}
  [resposta (api/get-state utilitarios-test/executa-handler novo-livro/handler)]
  (match? 400 (:status resposta))
  (match? {:global-errors ["Nao existe o autor referenciado"]} (:body resposta)))

(api/defflow nao-deve-cadastrar-com-titulo-duplicado
  {:init (constantly (utilitarios-test/cria-contexto-com-payload-e-dados
                      payload-livro-com-titulo-duplicado versao-banco (atom-id)))}
  [resposta (api/get-state utilitarios-test/executa-handler novo-livro/handler)]
  (match? 400 (:status resposta))
